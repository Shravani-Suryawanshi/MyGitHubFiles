...
engine = create_engine("mysql+pymysql://root:Root123$@localhost/cv")
...
# sql connector
con = pymysql.connect(host='localhost',user='root',password='root123',db='resume_schema')
cursor = con.cursor()
...
def run():
    ...
    link = '<b>Built by :- \n<a  style="text-decoration: none; color: #021659;">ARPITA SHINDE  \n</a></b><b><a  style="text-decoration: none; color: #021659;">SHRAVANI SURYAWANSHI</a></b>'
    ...
    # Create the DB
    db_sql = """CREATE DATABASE IF NOT EXISTS resume_schema;"""
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        <b>Built by <a  style="text-decoration: none; color: #021659;">ARPITA SHINDE</a></b>
        <b>And  <a  style="text-decoration: none; color: #021659;">SHRAVANI SURYAWANSHI</a></b> 
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        if st.button('Login'):
            ...
            ## Credentials 
            if ad_user == 'myproject' and ad_password == 'admin@project':
